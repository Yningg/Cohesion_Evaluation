...
3. If there are multiple communities for a query node, take the average of coheisveness value
    ...
    with open(algo_result_dir + file, 'r') as f:
        ...
        if algorithm == ["ALS", "WCF-CRC", "I2ACSM"]:
            for line in lines:
                ...
                results.append([node, value, params, community_node_list, coheisveness_dim])
            ...
            for line in lines:
                ...
                results.append([node, params, community_node_list, coheisveness_dim])
            ...
            for line in lines:
                ...
                results.append([node, community_node_list, coheisveness_dim])
    return results
