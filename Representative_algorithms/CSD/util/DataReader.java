...
public class DataReader {
    ...
    //     this.rootName = "D:/Work it/PIANO/Datasets/Simplified_dataset/CSD_Dataset/" + dataName + "/";
    //      numOfNodes = 0;
    ...
    public DataReader(String dataName) {
        ...
        try {
            ...
            // Initialize the graph arrays with the total number of nodes
            inGraph = new int[numOfNodes][];
            outGraph = new int[numOfNodes][];
            inNum = new int[numOfNodes];
            outNum = new int[numOfNodes];
    ...
    // Method to convert node ID without sampling
    public int convertID(int nodeId) {
        return nodeId;
    }
