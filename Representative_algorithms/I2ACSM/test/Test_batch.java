...
import Utils.ParameterCombination;
...
public class Test_batch {
	...
	{	
		...
		String dataset_dir = "D:/Cohesion_Evaluation/Input_Datasets/I2ACSM_dataset/";
		String query_node_dir = "D:/Cohesion_Evaluation/Original_Datasets/Query_Nodes/";
		String results_path = "D:/Cohesion_Evaluation/Algorithm_Output/I2ACSM_Results/I2ACSM_results_" + dataset_name + ".txt";
		...
		List<BigInteger> query_node_list = FileConverter.FileToQueryNodeList(query_node_path);
		...
		*/
		...
		for (BigInteger qId: query_node_list) {
			...
			for (ParameterCombination combination : combinations) {
                ...
                List<BigInteger> community_vertex_list = new ArrayList<>();
