...
public class Graph {
	...
	private Map<BigInteger, Vertex> vertexMap = new HashMap<BigInteger, Vertex> ();
	...
	public Map<BigInteger, Vertex> getVertexMap() {
		return vertexMap;
	}

	public void setVertexMap(Map<BigInteger, Vertex> vertexMap) {
	...
	public void initIAB() {
		float maxIAB = Long.MIN_VALUE;
		for (BigInteger vid : this.getVertexMap().keySet()) {
	...
	private float getIAB(BigInteger fromId, BigInteger toId) {
